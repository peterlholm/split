...
if __name__ == "__main__":
    ...
    split_pcl(infile, "out/stl1", splitsize=20)
    random_split(infile, "out/stl1_random", splitsize=20)
    infile = Path(__file__).parent / 'stl' / 't9UJscan.ply'
    split_pcl(infile, "out/stl2", splitsize=20)
    random_split(infile, "out/stl2_random", splitsize=20)
